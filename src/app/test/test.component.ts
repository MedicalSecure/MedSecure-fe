...
export class TestComponent implements AfterViewInit {
  ...
  filterByRoom() {
    this.dataSource.data= ELEMENT_DATA.sort((a, b) => a.room - b.room);
   }
