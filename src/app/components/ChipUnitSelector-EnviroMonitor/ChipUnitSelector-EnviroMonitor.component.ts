...
@Component({
  ...
  imports: [FormsModule,
    ...
    ReactiveFormsModule,
    AsyncPipe, HttpClientModule, CommonModule, WidgetsPageComponent, MultiSenseEnviroScanComponent],
  templateUrl: './ChipUnitSelector-EnviroMonitor.component.html',
  styleUrl: './ChipUnitSelector-EnviroMonitor.component.css'
})
export class ChipUnitSelectorEnviroMonitor implements OnInit {
