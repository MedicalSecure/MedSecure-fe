...
import { ChartOptionsCircle } from '../../components/charts/radialbar-charts/radialbar-charts.component'
...
@Component({
  selector: 'app-detection-temp',
  standalone: true,
  imports: [MatProgressSpinnerModule,HttpClientModule, DashedComponent,ScatterChartsComponent,RadialbarChartsComponent],
  templateUrl: './detection-temp.component.html',
  styleUrl: './detection-temp.component.css'
})
export class DetectionTempComponent {
