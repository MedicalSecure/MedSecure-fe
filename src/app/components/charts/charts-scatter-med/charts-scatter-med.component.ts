...
@Component({
  selector: 'app-charts-scatter-med',
  standalone: true,
  imports: [NgApexchartsModule],
  templateUrl: './charts-scatter-med.component.html',
  styleUrl: './charts-scatter-med.component.css'
})
export class ChartsScatterMedComponent {
